...
def main():
    ...
    os.makedirs("static/audio/module-3/swaps", exist_ok=True)
    
    # Input files for slides 1&2
    input_files = [
        "static/audio/module-3/swaps/module3_swaps_01.mp3",
        "static/audio/module-3/swaps/module3_swaps_02.mp3"
    ]
    
    # Output file
    output_file = "static/audio/module-3/swaps/module3_swaps_01_02_combined.mp3"
