...
<header class="w-full flex items-center justify-between py-4 px-6 bg-white shadow-sm mb-8">
  ...
  <div class="flex items-center gap-4">
    <a href="/mainMenuV2" class="text-blue-600 hover:underline text-sm font-medium">Show V2</a>
...
<main class="w-full max-w-3xl mx-auto px-4">
  ...
  <section class="mb-10 text-center">
    <h2 class="text-2xl font-semibold text-gray-800 mb-2">Welcome to your training dashboard (V1)</h2>
