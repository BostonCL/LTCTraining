<script lang="ts">
	...
	const introScript = [
		{ 
			...
			audio: getR2Url('/audio/introduction/intro_01_02_combined.mp3'),
			image: getR2Url('/images/introduction/basketballBackground.jpg'),
		...
		{ 
			...
			audio: [
				getR2Url('/audio/introduction/intro_12_title.mp3'),
				getR2Url('/audio/introduction/intro_12_segment1.mp3'),
				getR2Url('/audio/introduction/intro_12_segment2.mp3'),
				getR2Url('/audio/introduction/intro_12_segment3.mp3')
			],
			whiteboardText: [
			...
			titleAudio: getR2Url('/audio/introduction/intro_12_title.mp3')
		},
		{ 
			...
			audio: getR2Url('/audio/introduction/intro_12_13_14_15_16_combined.mp3'),
			image: getR2Url('/images/introduction/basketballBackground.jpg'),
			videoAnimation: getR2Url('/images/ballSackIntroS12.mov'),
			titleAudio: getR2Url('/audio/introduction/intro_13_title.mp3')
		}
	];
	...
	<div class="w-full max-w-5xl px-4 mx-auto mt-8">
		<div class="w-full bg-black rounded-lg overflow-hidden shadow-lg mb-6 relative">
			<div class="relative aspect-video bg-black w-full overflow-hidden">
				<img 
					src={getR2Url('/images/introduction/basketballBackground.jpg')}
