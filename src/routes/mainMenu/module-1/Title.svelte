...
const script = [
	{
		...
		audio: '/api/assets/audio/module-1/06-title/module1_title_01.mp3',
		image: '/api/assets/images/module-1/title/Titlescreen.png'
	},
	{
		text: 'This is a very important column because this is how we will time out the rest of the show.',
		audio: '/api/assets/audio/module-1/06-title/module1_title_02.mp3',
		image: '/api/assets/images/module-1/title/Titlescreen.png'
	}
];
