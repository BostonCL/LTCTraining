...
const script = [
	{
		...
		audio: '/api/assets/audio/module-1/02-start-time-real-time/module1_starttimerealtime_01.mp3',
		image: '/api/assets/images/module-1/start-time-real-time/LCSheetRS.png'
	},
	{
		...
		audio: '/api/assets/audio/module-1/02-start-time-real-time/module1_starttimerealtime_02.mp3',
		image: '/api/assets/images/module-1/start-time-real-time/LCSheetRS.png'
	},
	{
		text: 'This is an important column because this is how we will time out the rest of the show.',
		audio: '/api/assets/audio/module-1/02-start-time-real-time/module1_starttimerealtime_03.mp3',
		image: '/api/assets/images/module-1/start-time-real-time/LCSheetRS.png'
	},
	{
		text: 'The start time will always be at the top of the page in the second column.',
		audio: '/api/assets/audio/module-1/02-start-time-real-time/module1_starttimerealtime_04.mp3',
		image: '/api/assets/images/module-1/start-time-real-time/LCSheetRS.png'
	},
	{
		...
		audio: '/api/assets/audio/module-1/02-start-time-real-time/module1_starttimerealtime_05.mp3',
		image: '/api/assets/images/module-1/start-time-real-time/LCSheetRS.png'
	},
	{
		...
		audio: '/api/assets/audio/module-1/02-start-time-real-time/module1_starttimerealtime_06.mp3',
		image: '/api/assets/images/module-1/start-time-real-time/LCSheetRS.png'
	}
];
