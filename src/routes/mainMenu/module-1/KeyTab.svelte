  ...
  const keyTabScript = [
    {
      ...
      audio: getR2Url('/audio/module-1/keytab/keytab_01.mp3'),
      image: getR2Url('/images/module-1/keytab/KeyTab.png')
    },
    {
      text: "Contingency Plan: This plan outlines what to do if a game runs long — for example, which shows might be cut or adjusted.",
      audio: getR2Url('/audio/module-1/keytab/keytab_02.mp3'),
      image: getR2Url('/images/module-1/keytab/KeyTab2.png')
    },
    {
      ...
      audio: getR2Url('/audio/module-1/keytab/keytab_03.mp3'),
      image: getR2Url('/images/module-1/keytab/KeyTab3.jpg')
    },
    {
      ...
      audio: getR2Url('/audio/module-1/keytab/keytab_04.mp3'),
      image: getR2Url('/images/module-1/keytab/KeyTab4.png')
    }
  ];
