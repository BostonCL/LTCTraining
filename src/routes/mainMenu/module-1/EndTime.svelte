...
const script = [
  {
    ...
    audio: '/api/assets/audio/module-1/end-time/module1_endtime_01.mp3',
    image: '/api/assets/images/module-1/end-time/EndTimeSheet.png'
  }
];
...
<YouTubeTemplate script={script} title={videoInfo.title} image="/api/assets/images/module-1/end-time/EndTimeSheet.png" onNextSubmodule={goNext} progressId={progressId} nextButtonText={nextButtonText} /> 