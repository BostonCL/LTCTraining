  ...
  const script = [
    {
      ...
      audio: getR2Url('/audio/module-3/swaps/module3_swaps_01_02_combined.mp3'),
      image: getR2Url('/images/module-3/Swaps1.png'),
    },
    {
      ...
      audio: getR2Url('/audio/module-3/swaps/module3_swaps_03.mp3'),
      image: getR2Url('/images/module-3/Swaps2.png'),
    },
    {
      ...
      audio: getR2Url('/audio/module-3/swaps/module3_swaps_04.mp3'),
      image: getR2Url('/images/module-3/Swaps3.png'),
    },
    {
      text: 'Now, let’s go through the steps you need to follow.',
      audio: getR2Url('/audio/module-3/swaps/module3_swaps_05.mp3'),
      image: getR2Url('/images/module-3/Swaps1.png'),
    },
    {
      ...
      audio: getR2Url('/audio/module-3/swaps/module3_swaps_06.mp3'),
      image: getR2Url('/images/module-3/Swaps4.png'),
    },
    {
      text: 'Step 2 is to verify the spot end time. The unit has a 1 AM spot end time. Now keep that in mind when moving it.',
      audio: getR2Url('/audio/module-3/swaps/module3_swaps_07.mp3'),
      image: getR2Url('/images/module-3/Swaps5.png'),
    },
    {
      ...
      audio: getR2Url('/audio/module-3/swaps/module3_swaps_08.mp3'),
      image: getR2Url('/images/module-3/Swaps6.png'),
    },
    {
      ...
      audio: getR2Url('/audio/module-3/swaps/module3_swaps_09.mp3'),
      image: getR2Url('/images/module-3/Swaps7.png'),
    },
    {
      ...
      audio: getR2Url('/audio/module-3/swaps/module3_swaps_10.mp3'),
      image: getR2Url('/images/module-3/Swaps8.png'),
    },
    {
      ...
      audio: getR2Url('/audio/module-3/swaps/module3_swaps_11.mp3'),
      image: getR2Url('/images/module-3/Swaps9.png'),
    },
    {
      ...
      audio: getR2Url('/audio/module-3/swaps/module3_swaps_12.mp3'),
      image: getR2Url('/images/module-3/Swaps10.png'),
    },
    {
      ...
      audio: getR2Url('/audio/module-3/swaps/module3_swaps_13.mp3'),
      image: getR2Url('/images/module-3/Swaps11.png'),
    },
    {
      ...
      audio: getR2Url('/audio/module-3/swaps/module3_swaps_14.mp3'),
      image: getR2Url('/images/module-3/Swaps12.png'),
    },
    {
      ...
      audio: getR2Url('/audio/module-3/swaps/module3_swaps_15.mp3'),
      image: getR2Url('/images/module-3/Swaps13.png'),
    },
    {
      ...
      audio: getR2Url('/audio/module-3/swaps/module3_swaps_16.mp3'),
      image: getR2Url('/images/module-3/Swaps14.jpg'),
    },
    {
      ...
      audio: getR2Url('/audio/module-3/swaps/module3_swaps_17_18_combined.mp3'),
      image: getR2Url('/images/module-3/Swaps13.png'),
    },
  ];
