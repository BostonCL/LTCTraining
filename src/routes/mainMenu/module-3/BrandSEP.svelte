...
const script = [
  {
    ...
    audio: getR2Url('/audio/module-3/brand-sep/module3_brandsep_01.mp3'),
    whiteboardText: [
      '**__Brand SEP__**',
    ...
    titleAudio: getR2Url('/audio/module-3/brand-sep/module3_brandsep_01_title.mp3'),
  ...
  },
  {
    ...
    audio: getR2Url('/audio/module-3/brand-sep/module3_brandsep_02.mp3'),
    whiteboardText: [
      '**__Additional Guidelines:__**',
      '• 15-second ads can run between 30-second ads of the same brand.',
      '• However, 15-second and 30-second ads cannot appear in the same commercial break. Never schedule more than one commercial from the same brand in the same break.'
    ],
    titleAudio: getR2Url('/audio/module-3/brand-sep/module3_brandsep_02_title.mp3'),
    image: getR2Url('/images/introduction/basketballBackground.png')
  },
  {
    text: `Exceptions:\n• You may break the 30 minute rule during live windows.\n• Also, the Brand Sep resets when starting a new game or show.`,
    audio: getR2Url('/audio/module-3/brand-sep/module3_brandsep_03.mp3'),
    whiteboardText: [
      '**__Exceptions:__**',
      '• You may break the 30 minute rule during live windows.',
      '• Also, the Brand Sep resets when starting a new game or show.'
    ],
    titleAudio: getR2Url('/audio/module-3/brand-sep/module3_brandsep_03_title.mp3'),
    image: getR2Url('/images/introduction/basketballBackground.png')
  }
];
