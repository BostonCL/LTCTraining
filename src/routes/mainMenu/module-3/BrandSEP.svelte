...
const script = [
  {
    ...
    audio: '/static/audio/module-3/brand-sep/module3_brandsep_01.mp3',
    whiteboardText: [
      'Brand SEP',
  ...
  },
  {
    ...
    audio: '/static/audio/module-3/brand-sep/module3_brandsep_02.mp3',
    whiteboardText: [
  ...
  },
  {
    ...
    audio: '/static/audio/module-3/brand-sep/module3_brandsep_03.mp3',
    whiteboardText: [
      'Exceptions:',
      '• You may break the 30 minute rule during live windows.',
      '• Also, the Brand Sep resets when starting a new game or show.'
