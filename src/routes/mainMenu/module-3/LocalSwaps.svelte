...
const script = [
  {
    ...
    audio: getR2Url('/audio/module-3/local-swaps/module3_localswaps_01.mp3'),
    image: getR2Url('/images/module-3/local-swaps/Local1.png')
  },
  {
    ...
    audio: getR2Url('/audio/module-3/local-swaps/module3_localswaps_02.mp3'),
    image: getR2Url('/images/module-3/local-swaps/Local2.png')
  },
  {
    ...
    audio: getR2Url('/audio/module-3/local-swaps/module3_localswaps_03.mp3'),
    image: getR2Url('/images/module-3/local-swaps/Local2.png')
  },
  {
    ...
    audio: getR2Url('/audio/module-3/local-swaps/module3_localswaps_04.mp3'),
    image: getR2Url('/images/module-3/local-swaps/Local3.jpg')
  },
  {
    ...
    audio: getR2Url('/audio/module-3/local-swaps/module3_localswaps_05.mp3'),
    image: getR2Url('/images/module-3/local-swaps/Local5v2.jpg')
  },
  {
    ...
    audio: getR2Url('/audio/module-3/local-swaps/module3_localswaps_06.mp3'),
    image: getR2Url('/images/module-3/local-swaps/Local6.png')
  },
  {
    ...
    audio: getR2Url('/audio/module-3/local-swaps/module3_localswaps_07_08_combined.mp3'),
    image: getR2Url('/images/module-3/local-swaps/Local2.png')
  },

  {
    text: "Add a note that says: 'Moved to Break 5 of the 10 PM game.'",
    audio: getR2Url('/audio/module-3/local-swaps/module3_localswaps_10.mp3'),
    image: getR2Url('/images/module-3/local-swaps/LocalV2.jpg')
  },
  {
    ...
    audio: getR2Url('/audio/module-3/local-swaps/module3_localswaps_10_11_combined.mp3'),
    image: getR2Url('/images/module-3/local-swaps/Local10v2.jpg')
  },
  {
    ...
    audio: getR2Url('/audio/module-3/local-swaps/module3_localswaps_11_12_combined.mp3'),
    image: getR2Url('/images/module-3/local-swaps/LocalV2_slide11.jpg')
  }
];
