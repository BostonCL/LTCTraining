...
const script = [
  {
    ...
    audio: '/static/audio/module-3/local-swaps/module3_localswaps_01.mp3',
    image: '/static/images/module-3/local-swaps/Local1.png'
  },
  {
    ...
    audio: '/static/audio/module-3/local-swaps/module3_localswaps_02.mp3',
    image: '/static/images/module-3/local-swaps/Local2.png'
  },
  {
    ...
    audio: '/static/audio/module-3/local-swaps/module3_localswaps_03.mp3',
    image: '/static/images/module-3/local-swaps/Local2.png'
  },
  {
    ...
    audio: '/static/audio/module-3/local-swaps/module3_localswaps_04.mp3',
    image: '/static/images/module-3/local-swaps/Local4.png'
  },
  {
    ...
    audio: '/static/audio/module-3/local-swaps/module3_localswaps_05.mp3',
    image: '/static/images/module-3/local-swaps/Local5.png'
  },
  {
    ...
    audio: '/static/audio/module-3/local-swaps/module3_localswaps_06.mp3',
    image: '/static/images/module-3/local-swaps/Swaps13.png'
  },
  {
    ...
    audio: '/static/audio/module-3/local-swaps/module3_localswaps_07.mp3',
    image: '/static/images/module-3/local-swaps/Swaps13.png'
  },
  {
    ...
    audio: '/static/audio/module-3/local-swaps/module3_localswaps_08.mp3',
    image: '/static/images/module-3/local-swaps/Swaps13.png'
  },
  {
    text: "Then, paste the local unit into its new spot. Mark it blue to show it's airing there.",
    audio: '/static/audio/module-3/local-swaps/module3_localswaps_09.mp3',
    image: '/static/images/module-3/local-swaps/Local9.png'
  },
  {
    text: "Add a note that says: 'Moved to Break 5 of the 10 PM game.' 'Moved from Break 11 of the 12 PM game.'",
    audio: '/static/audio/module-3/local-swaps/module3_localswaps_10.mp3',
    image: '/static/images/module-3/local-swaps/Local10.png'
  },
  {
    text: "This is an additional slide for Local Swaps with specific content.",
    audio: '/static/audio/module-3/local-swaps/module3_localswaps_11.mp3',
    image: '/static/images/module-3/local-swaps/Local11.png'
  },
  {
    text: "After you insert the local: In your spreadsheet, mark it as 'No fill'.",
    audio: '/static/audio/module-3/local-swaps/module3_localswaps_12.mp3',
    image: '/static/images/module-3/local-swaps/Swaps13.png'
  },
  {
    ...
    audio: '/static/audio/module-3/local-swaps/module3_localswaps_13.mp3',
    image: '/static/images/module-3/local-swaps/Swaps13.png'
  },
  {
    ...
    audio: '/static/audio/module-3/local-swaps/module3_localswaps_14.mp3',
    image: '/static/images/module-3/local-swaps/Swaps13.png'
  }
];
