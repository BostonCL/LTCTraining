...
const script = [
  {
    ...
    audio: '/api/assets/audio/module-3/advertiser-conflicts/module3_advertiserconflicts_01.mp3',
    whiteboardText: [
  ...
  },
  {
    ...
    audio: '/api/assets/audio/module-3/advertiser-conflicts/module3_advertiserconflicts_02.mp3',
    whiteboardText: [
      'For example:',
      '• Geico and USAA should not air together, as they both sell insurance',
      '• Lowe’s and Home Depot are direct competitors in home improvement and must also be kept separate.'
  ...
  },
  {
    ...
    audio: '/api/assets/audio/module-3/advertiser-conflicts/module3_advertiserconflicts_03.mp3',
    whiteboardText: [
      'If you’re unsure',
  ...
  },
  {
    ...
    audio: '/api/assets/audio/module-3/advertiser-conflicts/module3_advertiserconflicts_04.mp3',
    whiteboardText: [
      'Why this matters:',
