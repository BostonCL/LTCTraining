...
const script = [
  {
    ...
    audio: '/api/assets/audio/module-3/intro/module3_intro_01.mp3',
  ...
  },
  {
    ...
    audio: '/api/assets/audio/module-3/intro/module3_intro_02.mp3',
    whiteboardText: [
      'Brand SEP',
  ...
  },
  {
    ...
    audio: '/api/assets/audio/module-3/intro/module3_intro_03.mp3',
    whiteboardText: [
  ...
  },
  {
    ...
    audio: '/api/assets/audio/module-3/intro/module3_intro_04.mp3',
    whiteboardText: [
