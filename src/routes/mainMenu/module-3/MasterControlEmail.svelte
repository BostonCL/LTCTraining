...
const script = [
  {
    ...
    audio: getR2Url('/audio/module-3/master-control-email/module3_mastercontrol_01.mp3'),
    image: getR2Url('/images/module-3/master-control-email/Swaps13.png')
  },
  {
    ...
    audio: getR2Url('/audio/module-3/master-control-email/module3_mastercontrol_02.mp3'),
    image: getR2Url('/images/module-3/master-control-email/Email1.png')
  },
  {
    ...
    audio: getR2Url('/audio/module-3/master-control-email/module3_mastercontrol_03.mp3'),
    image: getR2Url('/images/module-3/master-control-email/Email2.png')
  },
  {
    ...
    audio: getR2Url('/audio/module-3/master-control-email/module3_mastercontrol_04.mp3'),
    image: getR2Url('/images/module-3/master-control-email/Email3.png')
  },
  {
    ...
    audio: getR2Url('/audio/module-3/master-control-email/module3_mastercontrol_05.mp3'),
    image: getR2Url('/images/module-3/master-control-email/Emailv3.jpg')
  },
  {
    ...
    audio: getR2Url('/audio/module-3/master-control-email/module3_mastercontrol_06.mp3'),
    image: getR2Url('/images/module-3/master-control-email/Email5.png')
  },
  {
    ...
    audio: getR2Url('/audio/module-3/master-control-email/module3_mastercontrol_07.mp3'),
    image: getR2Url('/images/module-3/master-control-email/Email5.png')
  },
  {
    ...
    audio: getR2Url('/audio/module-3/master-control-email/module3_mastercontrol_08.mp3'),
    image: getR2Url('/images/module-3/master-control-email/Email5.png')
  }
];
