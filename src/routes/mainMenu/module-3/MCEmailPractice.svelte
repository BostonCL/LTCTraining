...
let data = [
  ...
  ["CUT", "10:35:40 PM", "National DR", "00:00:15", "GRAINGER: MOVING FORWARD 15", "GRAINGER", "600619", "DR ROS PRIME", "11:00:00 PM"],
  ["Moved From B5 of 8p", "09:35:00 PM", "Commercial", "00:00:15", "PEPSI (MOUNTAIN DEW): MTD T&R BAJA :15", "PEPSI", "600701", "ROS 24 HOUR", "05:59:00 AM"],
...
let cellColors: { [key: string]: string } = {
  ...
  '2-7': '#FF0000',
  '2-8': '#FF0000',
  // Set the row (with 'Moved From B5 of 8p') at index 31 to red in columns 1-8
  '31-1': '#FF0000',
  '31-2': '#FF0000',
  '31-3': '#FF0000',
  '31-4': '#FF0000',
  ...
  '31-7': '#FF0000',
  '31-8': '#FF0000',
  // Set row 32 to light blue in columns 1-8
  '32-1': '#00B0F0',
  '32-2': '#00B0F0',
  '32-3': '#00B0F0',
  '32-4': '#00B0F0',
