...
const script = [
  {
    ...
    audio: '/static/audio/module-2/yellow-unit/module2_yellowunit_01.mp3',
  ...
  },
  {
    ...
    audio: '/static/audio/module-2/yellow-unit/module2_yellowunit_02.mp3',
    whiteboardText: ['Unit Prioritization List']
  },
  {
    text: 'Show Specific',
    audio: '/static/audio/module-2/yellow-unit/module2_yellowunit_03.mp3',
    whiteboardText: ['Unit Prioritization List', '1st) Show Specific']
  },
  {
    text: 'Sports Spectacular',
    audio: '/static/audio/module-2/yellow-unit/module2_yellowunit_04.mp3',
    whiteboardText: ['Unit Prioritization List', '1st) Show Specific', '2nd) Sports Spectacular']
  },
  {
    text: 'ROS 24 Hour',
    audio: '/static/audio/module-2/yellow-unit/module2_yellowunit_05.mp3',
    whiteboardText: ['Unit Prioritization List', '1st) Show Specific', '2nd) Sports Spectacular', '3rd) ROS 24 Hour']
  },
  {
    text: 'ROS Prime',
    audio: '/static/audio/module-2/yellow-unit/module2_yellowunit_06.mp3',
  ...
  },
  {
    ...
    audio: '/static/audio/module-2/yellow-unit/module2_yellowunit_07.mp3',
