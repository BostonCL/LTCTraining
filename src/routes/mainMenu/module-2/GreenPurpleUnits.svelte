...
// Green & Purple Units script (placeholder, update as needed)
const script = [
  {
    text: `Now let's talk about the other type of units you will see`,
    audio: '/static/audio/module-2/green-purple-units/module2_greenpurpleunits_01.mp3',
  ...
  },
  {
    ...
    audio: '/static/audio/module-2/green-purple-units/module2_greenpurpleunits_02.mp3',
    whiteboardText: ['Purple & Green Units']
  },
  {
    text: '',
    audio: '/static/audio/module-2/green-purple-units/module2_greenpurpleunits_03.mp3',
    whiteboardText: ['Purple & Green Units', '• Locals', '• DRs', '• Promos', '• PSAs']
  },
  {
    ...
    audio: '/static/audio/module-2/green-purple-units/module2_greenpurpleunits_04.mp3',
    whiteboardText: ['Locals', 'Fixed 90-sec local spots, filled with community content, marked in purple']
  },
  {
    ...
    audio: '/static/audio/module-2/green-purple-units/module2_greenpurpleunits_05.mp3',
    whiteboardText: ['DRs (Direct Response)', 'DRs generate additional revenue but are one of the first to be removed.']
  },
  {
    ...
    audio: '/static/audio/module-2/green-purple-units/module2_greenpurpleunits_06.mp3',
    whiteboardText: ['Promos', 'Promos boost network awareness']
  },
  {
    ...
    audio: '/static/audio/module-2/green-purple-units/module2_greenpurpleunits_07.mp3',
    whiteboardText: ['PSAs', 'non-revenue fillers, lowest priority, cut first']
  }
];
