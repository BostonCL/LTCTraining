...
const module2Script = [
  {
    ...
    audio: '/api/assets/audio/module-2/module2_intro.mp3'
  },
  {
    text: "The sold commercials are color coordinated:",
    audio: '/api/assets/audio/module-2/01-intro/module2_01_part1.mp3'
  },
  {
    text: "Sold commercials (the important stuff) are in YELLOW",
    audio: '/api/assets/audio/module-2/01-intro/module2_01_part2.mp3',
    whiteboardText: [
      "YELLOW are the SOLD commercials."
    ]
  },
  {
    text: "Local units are PURPLE",
    audio: '/api/assets/audio/module-2/01-intro/module2_01_part3.mp3',
    whiteboardText: [
      "Locals are PURPLE"
    ]
  },
  {
    ...
    audio: '/api/assets/audio/module-2/01-intro/module2_01_part4.mp3',
    whiteboardText: [
      "GREEN is the first to be cut because they are not worth as much."
    ]
  }
];
...
function handleNext() {
  // Optionally, dispatch an event or navigate away when done
}
</script>
