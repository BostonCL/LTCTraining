...
const script = [
  {
    ...
    audio: '/api/assets/audio/module-2/unit-prioritization-details/module2_unitprioritizationdetails_01.mp3',
  ...
  },
  {
    ...
    audio: '/api/assets/audio/module-2/unit-prioritization-details/module2_unitprioritizationdetails_02.mp3',
    whiteboardText: ['Show Specific', 'High-value, mandatory units tied to specific shows/games']
  },
  {
    ...
    audio: '/api/assets/audio/module-2/unit-prioritization-details/module2_unitprioritizationdetails_03.mp3',
    whiteboardText: ['Sports Spectacular', 'High-value, mandatory units with limited placement flexibility']
  },
  {
    ...
    audio: '/api/assets/audio/module-2/unit-prioritization-details/module2_unitprioritizationdetails_04.mp3',
    whiteboardText: ['ROS 24 Hour', 'High-value, easy to move units, just watch the end times.']
  },
  {
    ...
    audio: '/api/assets/audio/module-2/unit-prioritization-details/module2_unitprioritizationdetails_05.mp3',
    whiteboardText: ['ROS Prime', 'Time restricted: 7 PM to 12 AM']
  },
  {
    ...
    audio: '/api/assets/audio/module-2/unit-prioritization-details/module2_unitprioritizationdetails_06.mp3',
    whiteboardText: ['Studio Encore/ Sports Encore', 'The first units to cut in sold inventory']
  }
];
