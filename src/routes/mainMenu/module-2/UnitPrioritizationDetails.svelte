...
const script = [
  ...
  },
  {
    ...
    audio: getR2Url('/audio/module-2/unit-prioritization-details/module2_unitprioritizationdetails_02.mp3'),
    whiteboardText: ['**__Show Specific__**', 'High-value, mandatory units tied to specific shows/games'],
    titleAudio: getR2Url('/audio/module-2/unit-prioritization-details/module2_unitprioritizationdetails_02_title.mp3')
  },
  {
    ...
    audio: getR2Url('/audio/module-2/unit-prioritization-details/module2_unitprioritizationdetails_03.mp3'),
    whiteboardText: ['**__Sports Spectacular__**', 'High-value, mandatory units with limited placement flexibility'],
    titleAudio: getR2Url('/audio/module-2/unit-prioritization-details/module2_unitprioritizationdetails_03_title.mp3')
  },
  {
    ...
    audio: getR2Url('/audio/module-2/unit-prioritization-details/module2_unitprioritizationdetails_04.mp3'),
    whiteboardText: ['**__ROS 24 Hour__**', 'High-value, easy to move units, just watch the end times.'],
    titleAudio: getR2Url('/audio/module-2/unit-prioritization-details/module2_unitprioritizationdetails_04_title.mp3')
  },
  {
    ...
    audio: getR2Url('/audio/module-2/unit-prioritization-details/module2_unitprioritizationdetails_05.mp3'),
    whiteboardText: ['**__ROS Prime__**', 'Time restricted: 7 PM to 12 AM'],
    titleAudio: getR2Url('/audio/module-2/unit-prioritization-details/module2_unitprioritizationdetails_05_title.mp3')
  },
  {
    ...
    audio: getR2Url('/audio/module-2/unit-prioritization-details/module2_unitprioritizationdetails_06.mp3'),
    whiteboardText: ['**__Studio Encore/ Sports Encore__**', 'The first units to cut in sold inventory'],
    titleAudio: getR2Url('/audio/module-2/unit-prioritization-details/module2_unitprioritizationdetails_06_title.mp3')
  }
];
